...
export default function Image({ src, sizes, unoptimized, priority, loading, className={styles.searchbar}: className, quality, width, height, objectFit, objectPosition, loader, ...all }: ImageProps): JSX.Element;
export {};
